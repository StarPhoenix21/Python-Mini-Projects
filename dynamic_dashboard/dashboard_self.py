...
if csv_file:
    try:
        ...
        # Graph Selection (Dropdown for Graphs)
        st.sidebar.subheader("Select Graph Type")
        graph_type = st.sidebar.selectbox("Choose the graph type", ["None", "Bar Plot", "Pie Chart", "Time Series Plot", "Scatter Plot", "Histogram", "Box Plot", "Bubble Chart", "Treemap", "Correlation Heatmap"])
        ...
        graph_counter = 0  # To alternate between columns

        # Function to assign graphs to columns alternately
        def assign_column(graph_component, counter):
        ...
        # Generating graphs based on the dropdown selection
        if graph_type == "Bar Plot":
            ...
            assign_column(bar_plot, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Pie Chart":
            ...
            assign_column(pie_chart, graph_counter)
            graph_counter += 1

        if graph_type == "Time Series Plot":
            ...
            assign_column(time_series_plot, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Scatter Plot":
            ...
            assign_column(scatter_plot, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Histogram":
            ...
            assign_column(histogram, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Box Plot":
            ...
            assign_column(box_plot, graph_counter)
            graph_counter += 1

        if graph_type == "Bubble Chart":
            def bubble_chart():
            ...
            assign_column(bubble_chart, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Treemap":
            ...
            assign_column(treemap, graph_counter)
            graph_counter += 1
        ...
        if graph_type == "Correlation Heatmap":
            ...
            assign_column(heatmap, graph_counter)
            graph_counter += 1
